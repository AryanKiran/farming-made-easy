...
plt.plot(Y_test.ravel(), color = 'red', label = 'Observed Crop Location')
plt.plot(predict.ravel(), color = 'green', label = 'Predicted Crop Location')
plt.title('SVM Crop Location Forecasting')
plt.xlabel('Original Observed Crop Locations')
plt.ylabel('Forecasting Crop Locations')
plt.legend()
plt.show()
print(predict)
